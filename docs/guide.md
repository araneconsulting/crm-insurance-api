...
When it is started up, it serves at http://localhost:5000.
...
>curl http://localhost:5000/posts/1 -d "{\"title\":\"updated post\",\"content\":\"content of my upated post\"}" -H "Content-Type:application/json" -X PUT
...
>curl http://localhost:5000/posts/1 -X DELETE
true
...
Grab [the source codes from my github](https://github.com/liuver/nestjs-sample).
