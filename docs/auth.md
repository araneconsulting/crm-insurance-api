...
{"username":"liuver","email":"liuver@example.com","id":"5f2d0e486a96be1200fefcec","roles":["USER"]}
```

Grab [the source codes from my github](https://github.com/liuver/nestjs-sample), switch to branch [feat/auth](https://github.com/liuver/nestjs-sample/blob/feat/auth).